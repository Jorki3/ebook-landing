<script>
  ...
  let questionCurrentlyExplained = $state(-1);

  function onclick(index) {
    if (questionCurrentlyExplained === index)
      return (questionCurrentlyExplained = -1);
...
<section class="landing-page-section">
  <h2 class="mb-l">Frequently asked sections</h2>

  <div class="faq-container">
    {#each faqs as faq, index}
      <FaqItem
        {faq}
        isExpanded={index === questionCurrentlyExplained}
