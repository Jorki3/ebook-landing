...
<section class="hero">
  <div class="hero-showcase text-center bold">
    ...
    <h1 class="puple mb-xs">SPAIN</h1>

    <h4 class="italic semi-bold">
      Thre's no need to make the same mistakes I made
    </h4>

    <img src={bookCover} class="book-cover" alt="" />
    <img src={phoneCover} class="phone-cover" alt="" />
  </div>
